...
// 여기서는 FILE이라는 URI를 처리함
@Controller
@RequestMapping(value = "/file")
public class FileController {
	
	private static final Logger logger = LoggerFactory.getLogger(FileController.class);
// FILE URI의 UPLOAD uri를 처리함
	...
	public void upload(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		File file = new File("C:/Users/wjdgn/OneDrive/바탕 화면/data/"+name);
	...
	public void download1(HttpServletRequest request, HttpServletResponse response) throws Exception {
		File file = new File("C:\\Users\\wjdgn\\OneDrive\\바탕 화면\\data\\1.zip");
